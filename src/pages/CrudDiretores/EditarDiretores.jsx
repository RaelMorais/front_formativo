  ...
  useEffect(() => {
    ...
    async function carregarDados() {
      try {
        ...
        // Força cargo como 'D' para evitar erro no z.literal
        reset({
          ...res.data,
          cargo: 'D'
        });
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <h2 className="text-2xl font-bold text-center mb-4">Editar Diretor</h2>
        ...
        {/* Campo oculto para garantir cargo "D" */}
