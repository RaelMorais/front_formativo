            ...
            <div className="max-w-3xl mx-auto">
                <a href="#" className="flex justify-center ">
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200 hoover-text-blue-400">
                        ...
                        <li><a href="#" className=" text-gray-800 hover:text-gray-900">Logout</a></li>
                    </ul>
                    <div class="flex space-x-10 justify-center items-center mb-14">
                        {/* X Svg */}
                        <a href="#" className="block  text-gray-900 transition-all duration-200 hover:text-black-100 ">
                        ...
                        {/* Instagram Svg */}
                        <a href="#" className="block  text-gray-900 transition-all duration-200 hover:text-purple-600 ">
                        ...
                        {/* Facebook Svg */}
                        <a href="#" className="block  text-gray-900 transition-all duration-200 hover:text-indigo-600 "> 
